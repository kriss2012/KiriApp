...
export declare const chatWithKiri: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
export declare const updateSpecialization: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
