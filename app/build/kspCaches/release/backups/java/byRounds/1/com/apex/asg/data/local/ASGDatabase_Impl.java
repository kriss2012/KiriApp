...
public final class ASGDatabase_Impl extends ASGDatabase {
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(2) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoCachedEvents.equals(_existingCachedEvents)) {
          return new RoomOpenHelper.ValidationResult(false, "cached_events(com.apex.asg.data.local.EventEntity).\n"
                  + " Expected:\n" + _infoCachedEvents + "\n"
        ...
        if (!_infoUsersVault.equals(_existingUsersVault)) {
          return new RoomOpenHelper.ValidationResult(false, "users_vault(com.apex.asg.data.local.AalUserEntity).\n"
                  + " Expected:\n" + _infoUsersVault + "\n"
                  + " Found:\n" + _existingUsersVault);
        }
        ...
        if (!_infoInstitutionsMdm.equals(_existingInstitutionsMdm)) {
          return new RoomOpenHelper.ValidationResult(false, "institutions_mdm(com.apex.asg.data.local.InstitutionEntity).\n"
        ...
        if (!_infoAalActivitiesHistory.equals(_existingAalActivitiesHistory)) {
          return new RoomOpenHelper.ValidationResult(false, "aal_activities_history(com.apex.asg.data.local.AalActivityEntity).\n"
        ...
        if (!_infoEcosystemBoardCache.equals(_existingEcosystemBoardCache)) {
          return new RoomOpenHelper.ValidationResult(false, "ecosystem_board_cache(com.apex.asg.data.local.EcosystemBoardEntity).\n"
        ...
        if (!_infoAiMatchesVault.equals(_existingAiMatchesVault)) {
          return new RoomOpenHelper.ValidationResult(false, "ai_matches_vault(com.apex.asg.data.local.AiResourceMatchEntity).\n"
                  + " Expected:\n" + _infoAiMatchesVault + "\n"
        ...
        if (!_infoJobsProjectsMdm.equals(_existingJobsProjectsMdm)) {
          return new RoomOpenHelper.ValidationResult(false, "jobs_projects_mdm(com.apex.asg.data.local.JobProjectEntity).\n"
